...
def makescorematrix(mefile='me2x5'):
    me_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), '../datas', mefile)
    matrix = {}
...
def makesequencematrix(splice='splicemodels/splice5sequences'):
    splice_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), '../datas' ,  splice)
    matrix = {}
